    ...
    OnePageNav.prototype = {
        ...
        scrollTo: function (target, callback) {
            ...
            if (jQuery(".arlo_tm_topbar").length) {
                $("html, body").animate({ scrollTop: offset - topbar + 2 }, this.config.scrollSpeed, this.config.easing, callback);
            } else {
...
function initMap() {
    ...
    var marker = new google.maps.Marker({ position: new google.maps.LatLng(34.0937458, -118.3614978), title: "ASL", map: map });
}
!(function (a, b, c, d) {
    function e(b, c) {
        (this.settings = null),
    ...
    (function (a, b, c, d) {
        ...
        (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (e.prototype.thumbnail = function (b, c) {
                ...
                "youtube" === c.type
                    ? ((f = "//img.youtube.com/vi/" + c.id + "../../hqdefault.html"), l(f))
                    : "vimeo" === c.type
                    ? a.ajax({
                          type: "GET",
    ...
    jQuery.mbYTPlayer = {
                                ...
                                onStateChange: function (event) {
                                    ...
                                    switch (state) {
                                        ...
                                        case 0:
                                            ...
                                            if (!data.loop && YTPlayer.isBackground) YTPlayer.wrapper.CSSAnimate({ opacity: 0 }, 2000);
                                            else if (data.loop) {
                                                YTPlayer.loop++;
                                            }
        ...
        buildYTPControls: function () {
            ...
            var controlBar = jQuery("<span/>")
                ...
                .addClass("mb_YTPBar")
                .css({ whiteSpace: "noWrap", position: YTPlayer.isBackground ? "fixed" : "absolute", zIndex: YTPlayer.isBackground ? 10000 : 1000 })
                .hide();
                ...
                if ((t.options.elementInViewport && (m = t.options.elementInViewport.getBoundingClientRect()), (t.isElementInViewport = m.bottom >= 0 && m.right >= 0 && m.top <= a && m.left <= i), e ? 1 : t.isElementInViewport)) {
                    ...
                    if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                        ...
                        r && t.options.enableTransform
                            ? (t.parentWithTransform && (b -= o), (l.transform = "translate3d(0, " + b + "px, 0)"))
                            : t.image.useImgTag
                            ? (l.top = b + "px")
                            : (t.bgPosVerticalCenter && (b += t.bgPosVerticalCenter), (l.backgroundPosition = "50% " + b + "px")),
                            (l.position = d ? "absolute" : "fixed");
                    }
                    t.css(t.image.$item, l),
                        t.options.onScroll && t.options.onScroll.call(t, { section: n, beforeTop: c, beforeTopEnd: p, afterTop: u, beforeBottom: g, beforeBottomEnd: f, afterBottom: h, visiblePercent: v, fromViewportCenter: y });
                }
            }
        }),
        n(e, "scroll", o),
...
if ($("#particles-js").length) {
    ...
    particlesJS("particles-js", {
        particles: {
            ...
            color: { value: "#888" },
            shape: { type: "circle", stroke: { width: 0, color: "#888" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 100, height: 100 } },
